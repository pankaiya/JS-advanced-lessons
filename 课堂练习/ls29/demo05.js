...
//注意，属性名表达式与简洁表示法，不能同时使用（就是键名如果用表达式，那么键值必须写），会报错。
// 报错
var foo = 'bar';
var bar = 'abc';
// var baz = { [foo] };//报错
...
console.log(Object.getPrototypeOf(obj));//Object {x: 1, y: 2}
Object.setPrototypeOf(obj,{z:3});
console.log(Object.getPrototypeOf(obj));//Object {z: 3}
...
console.log(obj2.c,obj2.d,obj2.a,obj2.b);//3 4 1 2
